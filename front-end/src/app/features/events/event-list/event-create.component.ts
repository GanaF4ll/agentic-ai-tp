...
@Component({
  ...
  template: `
    <div class="fixed inset-0 bg-base-300/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div class="card bg-base-100 w-full max-w-2xl shadow-2xl border border-base-200 rounded-[2.5rem] overflow-hidden animate-in fade-in zoom-in duration-300">
        <div class="card-body p-8">
          <div class="flex items-center justify-between mb-8">
            <h2 class="text-3xl font-black tracking-tighter text-primary">
          ...
          <form [formGroup]="eventForm" (ngSubmit)="onSubmit()" class="flex flex-col gap-5">
