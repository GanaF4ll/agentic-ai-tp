...
@Component({
  ...
  template: `
    <div class="fixed inset-0 bg-base-300/60 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      <div class="card bg-base-100 w-full max-w-lg shadow-2xl border border-base-200 rounded-t-[2rem] sm:rounded-[2.5rem] overflow-hidden animate-in fade-in slide-in-from-bottom-1/2 sm:zoom-in duration-300">
        <div class="card-body p-6 md:p-8">
          <div class="flex items-center justify-between mb-8">
            <h2 class="text-2xl md:text-3xl font-black tracking-tighter text-primary">Nouvel Administrateur</h2>
